...
if __name__ == '__main__':
    ...
    for i in range(args.client_num):
        train_dl, INPUT_SIZE, TIME_STAMP = gen_cbgru_dl(i, args.vul, noise_types[i], noise_rates[i], args.batch)
    ...
    global_test(server.global_model, test_dl, criterion, args, 'non_Fed_CBGRU')
