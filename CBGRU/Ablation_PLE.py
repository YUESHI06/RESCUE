...
from trainers.client import Fed_Ablation_client
...
if __name__ == "__main__":
    ...
    global_test(server.global_model, test_dl, criterion, args, 'Ablation_PLE')
