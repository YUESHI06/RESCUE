...
if __name__ == "__main__":
    ...
    for i in range(args.client_num):
        noise_dl = gen_client_dataloader(i, args.vul, args.noise_type, args.noise_rate)
    ...
    for epoch in range(args.epoch):
        ...
        for client_id in range(args.client_num):
            ...
            noise_dl = gen_client_noise_dl(client_id, args.vul, args.noise_type, conc_labels, args.noise_rate)
